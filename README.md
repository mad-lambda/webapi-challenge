...
Two parts i've learned about this week are routes used to break out modules of code to keep it cleaner and express middleware and how it's used.

- [x] Describe Middleware?

Middleware are functions that have access to request and response data and has the abilitiy to make changes to it before pushing the data forward.

- [x] Describe a Resource?

Resources are all data managed in the API.

- [x] What can the API return to help clients know if a request was successful?

Status codes and json objects.
